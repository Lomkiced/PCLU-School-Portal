...
import { School, BookOpen, ChevronRight, Loader2, AlertCircle } from "lucide-react";
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">
                        Select a grade level to manage its curriculum subjects
                    </p>
                </div>
            </div>
